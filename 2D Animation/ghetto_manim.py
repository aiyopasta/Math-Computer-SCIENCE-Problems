...
class ParamShape:
    def __init__(self, curve, color, start=0, stop=1, offset_x=0, offset_y=0, offset_theta=0,
...
class Ellipse(ParamShape):
    def __init__(self, center_x, center_y, a, b, color, start=0, stop=1, rot_theta=0, anchor_x=0, anchor_y=0):
        # a, b are parameters of the curve (major / minor axes)
        self.a = a
        self.b = b
        super().__init__(self.curve, color, start, stop, center_x, center_y, rot_theta, anchor_x, anchor_y, 1, 1)
...
class Circle(Ellipse):
    def __init__(self, center_x, center_y, radius, color, start=0, stop=1, rot_theta=0, anchor_x=0, anchor_y=0):
        super().__init__(center_x, center_y, radius, radius, color, start, stop, rot_theta, anchor_x, anchor_y)


class Rectangle(ParamShape):
    def __init__(self, topleft_x, topleft_y, botright_x, botright_y, color, start=0, stop=1, rot_theta=0, anchor_x=0, anchor_y=0):
        ...
        super().__init__(self.curve, color, start, stop, self.center_x, self.center_y, rot_theta, anchor_x, anchor_y, 1, 1)
...
class Cardoid(ParamShape):
    def __init__(self, color, center_x, center_y, scale=1, start=0, stop=1, rot_theta=0, anchor_x=0, anchor_y=0):
        super().__init__(self.curve, color, start, stop, center_x, center_y, rot_theta, anchor_x, anchor_y, scale, scale)
...
class ParamShapeGroup(ParamShape):
    ...
    def get_drawing_points(self, dt):
        ...
        for t in np.arange(self.bounds[0], self.bounds[1]+dt, dt):
            ...
            # print(curr_shape_num == len(self.shapes))
